...
python _zip_packer.py firefox vkopt_%answer%_firefox.xpi


@del vkopt_%answer%_opera.oex
python _zip_packer.py opera.extension vkopt_%answer%_opera.oex


@del vkopt_%answer%_chrome.zip
python _zip_packer.py chrome vkopt_%answer%_chrome.zip
...
cd ..
python builds\_zip_packer.py source builds\vkopt_%answer%_opera.zip "^vk(_|opt|lang)" "vkopt_debug.js"
