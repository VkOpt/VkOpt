...
var DefSetBits='yyyyynyyynyyy0y0yy0nyyynyyynyy0nyyynnnnyy0yy-3-0-#c5d9e7-#34a235';
...
function vkOpt_toogle(){
  if (ge('vkMoreSett') || !ge('settings_filters')) return;
...
function VkOptInit(){
  if (!window.vkscripts_ok || window.vkscripts_ok<vkOpt_js_count) {setTimeout(VkOptInit,10); return;}
	...
	if (dloc.match('settings')) vkOpt_toogle();
