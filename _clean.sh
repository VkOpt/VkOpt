...
rm builds/firefoxWebExt/scripts/vk*
...
rm builds/vkopt_chrome.zip builds/vkopt_firefox_webext.xpi builds/vkopt_firefox_jetpack.xpi builds/vkopt_firefox.xpi builds/vkopt_opera.oex
