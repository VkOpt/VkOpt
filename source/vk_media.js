   ...
   vkGetAlbumInfo(artist,track,function(data,tracks){
      ...
      */
      if (tracks){
         ...
         html='<ul>'+html+'</ul><div class="vk_tracks_search_btn"><div class="button_blue button_wide"><button onclick="vkAlbumCollectPlaylist()">Search</button></div></div>';
      }
